...
export interface ElectronAPI {
  ...
  /** 发起 GitHub Copilot（github.com）device-code OAuth 登录。 */
  githubCopilotOAuthLogin: () => Promise<import('@proma/shared').GithubCopilotOAuthLoginResult>
...
const electronAPI: ElectronAPI = {
  ...
  githubCopilotOAuthLogin: () => {
    return ipcRenderer.invoke(CHANNEL_IPC_CHANNELS.GITHUB_COPILOT_OAUTH_LOGIN)
  },
