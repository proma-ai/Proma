 ...
 */
export type WorkspaceComponentTab = 'todos' | 'calendar' | 'automations' | 'skills' | 'enterprise' | 'mcp' | 'memory'
export const WORKSPACE_COMPONENT_TABS: readonly WorkspaceComponentTab[] = ['todos', 'calendar', 'automations', 'skills', 'enterprise', 'mcp', 'memory']
