 ...
 */
export type WorkspaceComponentTab = 'todos' | 'calendar' | 'automations' | 'skills' | 'enterprise' | 'mcp' | 'memory' | 'vault'
export const WORKSPACE_COMPONENT_TABS: readonly WorkspaceComponentTab[] = ['todos', 'calendar', 'automations', 'skills', 'enterprise', 'mcp', 'memory', 'vault']
...
export const agentPromptSuggestionsAtom = atom<Map<string, string | null>>(new Map())
