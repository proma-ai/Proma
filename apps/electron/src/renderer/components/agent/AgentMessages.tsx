...
function AgentMessageItem({ message, sessionPath, attachedDirs, onRetry, onRetryInNewSession, onCompact, onGoToBilling }: AgentMessageItemProps): React.ReactElement | null {
...
export function AgentMessages({ sessionId, sessionModelId, messages, messagesLoaded, persistedSDKMessages, streaming, streamState, liveMessages, sessionPath, attachedDirs, stoppedByUser, onRetry, onRetryInNewSession, onFork, onRewind, onCompact, onGoToBilling }: AgentMessagesProps): React.ReactElement {
  const userProfile = useAtomValue(userProfileAtom)
