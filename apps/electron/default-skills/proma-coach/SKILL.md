...
- **AGENTS.md** —— Proma 工作区管理的项目规则、硬约束和关键入口；只按系统提示给出的绝对路径读取和维护
...
- 按需搜索系统提示给出的 Proma 工作区 AGENTS.md、Auto Memory 与 Skills，以及会话级 Context、项目级 Context 和相关本地文档——是否其实已有相关沉淀但没被使用？
...
> AGENTS.md 是**Proma 工作区管理的项目规范**——以系统提示给出的 `Proma 工作区 AGENTS.md` 绝对路径为准，记录项目硬规则和入口。Skill 是**可复用的流程**——跨项目可用，按需触发。规则放 AGENTS.md，流程做 Skill。
