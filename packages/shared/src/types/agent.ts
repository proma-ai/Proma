...
export const AGENT_IPC_CHANNELS = {
  ...
  OPEN_ADD_TAB_MENU: 'agent:open-add-tab-menu',
  SET_ADD_TAB_MENU_TOKEN: 'agent:set-add-tab-menu-token',
  SELECT_ADD_TAB_MENU_ACTION: 'agent:select-add-tab-menu-action',
